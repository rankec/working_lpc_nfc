...
void Keypad_Init()
{
    ...
    GPIO_InitPin(1, ROW_1);
    GPIO_InitPin(1, ROW_2);
    GPIO_InitPin(1, ROW_3);
    GPIO_InitPin(1, ROW_4);
}
...
char Keypad_WaitAndGetKey()
{
    while (1) {
        ...
        GPIO_SetPinValue(1, 0, ROW_1);
        GPIO_SetPinValue(1, 0, ROW_2);
        GPIO_SetPinValue(1, 0, ROW_3);
